...
#data for the P1 fe
data1 = np.loadtxt("C:/Users/khfz2/Desktop/Pro_docs/2A/PRe/FreeFem2/FreeFem/courbe_de_convergence_da_P1.txt")
h_values_P1 = data1[:, 0]
h1_norms_P1 = data1[:, 1]

#data for the P2 fe
data2 = np.loadtxt("C:/Users/khfz2/Desktop/Pro_docs/2A/PRe/FreeFem2/FreeFem/courbe_de_convergence_da_P2.txt")
h_values_P2 = data2[:, 0]
h1_norms_P2 = data2[:, 1]

#data for the P3 fe
data3 = np.loadtxt("C:/Users/khfz2/Desktop/Pro_docs/2A/PRe/FreeFem2/FreeFem/courbe_de_convergence_da_P3.txt")
h_values_P3 = data3[:, 0]
h1_norms_P3 = data3[:, 1]
