...
plt.loglog(h_values_P1, h1_norms_P1_noise+0.01,'b--',marker="+",label="Avec bruit")
#plt.plot(h_values_P1, 10**(intercept1) * h_values_P1**(slope1), 'r--')
#plt.plot(h_values_P1, h_values_P1**(-1), 'k--',label="Pente = 1")
#plt.xlabel("h")
#plt.xlabel("Erreur P1")
plt.legend()
#plt.subplot(1,3,2)
plt.loglog(h_values_P2, h1_norms_P2,'r',marker="o",label="Sans bruit")
plt.loglog(h_values_P2, h1_norms_P2_noise+0.001,'r--',marker="+",label="Avec bruit")
